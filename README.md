...
```text
reactor_model/
    eo_reactor_2d_gpu.py     # Core 2D EO reactor model and time integration
    ergun_closure.py         # Ergun-based pressure/velocity calculations (if separated)
    postprocessing.py        # Helper functions for rates, selectivities and plotting

data/
    example_outputs/         # Example simulation outputs (fields and profiles)

INFO.txt or README.md        # This file (description and usage notes)
